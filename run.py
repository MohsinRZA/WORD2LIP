...
# key_audio =os.path.join('/home/hp/PycharmProjects/obamaNet/data/audios','00001-000.wav') # '00003' # '00001-003' # 'karan' # '00002-002' # '00002-007' #
time_delay = 20
look_back = 50
n_epoch = 50
...
with open('data/pca/pkp53.pickle', 'rb') as pkl_file:
	video_kp = pkl.load(pkl_file)
with open('data/pca/pca53.pickle', 'rb') as pkl_file:
